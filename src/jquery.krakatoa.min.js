...
if(r>p){p=r;}}}h.attr("data-current",l.first);f.css("height",p);h.attr("data-krakatoa",true);if(l.autoplay){l.playing=true;c.fn.krakatoa.play(l,h);h.on("mouseleave",function(){c.fn.krakatoa.play(l,h);
