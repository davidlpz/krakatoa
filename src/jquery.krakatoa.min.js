...
}}}for(n=0;n<l.items&&l.first+n<j;n++){s=f.children().eq(l.first+n);s.addClass("current").css({display:"block",left:(k+l.gutter)*n});if(l.height!=="max"){p=l.height==="auto"?s.outerHeight(true):l.height;
}}h.attr("data-current",l.first);f.css("height",p);if(l.autoplay){l.playing=true;c.fn.krakatoa.play(l,h);h.on("mouseleave",function(){c.fn.krakatoa.play(l,h);
